      ...
      <ul>
        {
            ...
            onIncrement={this.handleIncrement, this.totalCountPlus} 
            onDecrement={this.handleDecrement, this.totalCountMinus} 
            onDelete={this.handleDlete, this.totalCountMinusAll}/>
